...
const {$_, __, agent_, module_, Message, Policy, Rule, Trigger, OnAssert, OnRetract, OnAttempt, Runner, Method} = runtime;
...
describe('Agent', function() {
  $$.tap();
  return describe('@run', () => it('should work', () => agent_(__main).run()));
});
